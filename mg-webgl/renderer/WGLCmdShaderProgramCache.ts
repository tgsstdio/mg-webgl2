...
import {IWGLCmdStateRendererCacheEntrypoint}
	from '../entrypoint/IWGLCmdStateRendererCacheEntrypoint';	
...
import {WGLBindingPointOffsetInfo}
	from '../pipeline/WGLBindingPointOffsetInfo';	
...
export class WGLCmdShaderProgramCache implements IWGLCmdShaderProgramCache {
      ...
      if (ds != null && ds.isValidDescriptorSet) {
        ...
        for (let resource of ds.resources) {
          if (resource != null) {
            ...
            // }
            if (resource.groupType
                == WGLDescriptorBindingGroup.UNIFORM_BUFFER) {
              ...
              == WGLDescriptorBindingGroup.COMBINED_IMAGE_SAMPLER) {
  ...
  private bindUniformBuffer(
    ...
    , resource: WGLDescriptorPoolResourceInfo
    ...
    if (this.mBoundPipelineLayout != null) {
      ...
      let uniformGroup = 
        this.mBoundPipelineLayout.ranges.get(resource.binding) as WGLBindingPointOffsetInfo;
