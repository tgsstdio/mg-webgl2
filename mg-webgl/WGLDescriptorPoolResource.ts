...
export class WGLDescriptorPoolResource<TData>
...

    {
      ...
      while (current != null) {
        if (current.count == request) {
          let result_0 = new WGLPoolResourceTicket();
...

    {
      ...
      while (current != null) {
        if (current.count > request) {
          ...
          let result_1 = new WGLPoolResourceTicket();
  ...
  private validateTicket(ticket: WGLPoolResourceTicket) {
