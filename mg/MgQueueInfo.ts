...
import { IMgCommandPool } from './IMgCommandPool'
import { MgCommandPoolCreateInfo } from './MgCommandPoolCreateInfo'
import { IMgThreadPartition } from './IMgThreadPartition'
import { MgCommandPoolCreateFlagBits } from './MgCommandPoolCreateFlagBits'
import { MgPhysicalDeviceMemoryProperties } from './MgPhysicalDeviceMemoryProperties'
import { MgThreadPartition } from './MgThreadPartition'
...
export class MgQueueInfo implements IMgQueueInfo {
	...
	createPartition (
		...
		let prop
			: { pMemoryProperties: MgPhysicalDeviceMemoryProperties | null }
